...
public static double kineticEnergy(Particle3d[] particles){
  ...
  public static  Vector3d seperation(Particle3d centre, Particle3d orbit){
    ...
    /**Determins the gradient of all of the planets relative to the sun
     *
     *
     *@param particles[] an array of Particle3d objects to calculate the gradient of the 
     *       tangent joing each plaent to the sun
     *@return double[] an array of doubles containg the gradients
     */ 
   ...
   /**Determins the gradient of all of the planets relative to the sun
     *
     *
     *@param particles an array of Particle3d objects to calculate orbit countthe gradient of the 
     *      
     */ 

   /**public static void orbitTrack(Particle3d[] particles){
	
	//calculate Initial Gradients 
	double[] grad = Particle3d.gradientCalcPlanets(particles);
	...
	double[] gradNew = Particle3d.gradientCalcPlanets(particles);
